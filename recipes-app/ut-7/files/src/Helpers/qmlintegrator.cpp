...
void QmlIntegrator::setHorn(const 	bool &val){
	...
	int QmlIntegrator::rightIndex(){
	return _rightIndex;
}
void QmlIntegrator::setRightIndex(const 	int &val){
	if (val == _rightIndex)
		return;
	_rightIndex = val;
	...
	int QmlIntegrator::bottomIndex(){
	return _bottomIndex;
}
void QmlIntegrator::setBottomIndex(const 	int &val){
	if (val == _bottomIndex)
		return;
	_bottomIndex = val;
...
void QmlIntegrator::setAlarmBEnable(const 	bool &val){
	...
	bool QmlIntegrator::alarmAPos(){
	return _alarmAPos;
}
void QmlIntegrator::setAlarmAPos(const 	bool &val){
	if (val == _alarmAPos)
		return;
	_alarmAPos = val;
	emit onAlarmAPosChanged();
}
 
	bool QmlIntegrator::alarmBPos(){
	return _alarmBPos;
}
void QmlIntegrator::setAlarmBPos(const 	bool &val){
	if (val == _alarmBPos)
		return;
	_alarmBPos = val;
	emit onAlarmBPosChanged();
}
...
void QmlIntegrator::setGateBEnabled(const 	bool &val){
	...
	bool QmlIntegrator::topbarVisible(){
	return _topbarVisible;
}
void QmlIntegrator::setTopbarVisible(const 	bool &val){
	...
	bool QmlIntegrator::bottombarVisible(){
	return _bottombarVisible;
}
void QmlIntegrator::setBottombarVisible(const 	bool &val){
	...
	int QmlIntegrator::rightPage(){
	return _rightPage;
}
void QmlIntegrator::setRightPage(const 	int &val){
	if (val == _rightPage)
		return;
	_rightPage = val;
	...
	int QmlIntegrator::bottomPage(){
	return _bottomPage;
}
void QmlIntegrator::setBottomPage(const 	int &val){
	if (val == _bottomPage)
		return;
	_bottomPage = val;
	...
	QString QmlIntegrator::memoryDescription(){
	return _memoryDescription;
}
void QmlIntegrator::setMemoryDescription(const 	QString &val){
