...
Q_PROPERTY(	Enums::TextOnChart textOnChart	 READ textOnChart	 WRITE setTextOnChart	 NOTIFY onTextOnChart	Changed)
...
Q_PROPERTY(	bool alarmAPos READ alarmAPos WRITE setAlarmAPos NOTIFY onAlarmAPosChanged)
Q_PROPERTY(	bool alarmBPos READ alarmBPos WRITE setAlarmBPos NOTIFY onAlarmBPosChanged)
...
Q_PROPERTY(	QString memoryDescription READ memoryDescription WRITE setMemoryDescription NOTIFY onMemoryDescriptionChanged)
	 	...
	 	bool _alarmAPos = true;
	 	bool _alarmBPos = true;
...
void setAlarmBEnable(const 	bool&val); 
	bool alarmAPos();
void setAlarmAPos(const 	bool&val); 
	bool alarmBPos();
void setAlarmBPos(const 	bool&val); 
	bool alarmDACActive();
...
void onAlarmAPosChanged();
void onAlarmBPosChanged();
